    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Sección existente de ProgramLibrary */}
                <div className="py-8 px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Dashboard Principal</h1>
                    
                    {/* Aquí puedes agregar otros componentes del dashboard */}

                    <ProgramLibrary resources={programResources} />
                    <TutorialLibrary resources={tutorialResources} />

                    {/* Más secciones del dashboard si es necesario */}
                </div>
